       ...
       <div class="header-right pull-right">
          <ul class="list-inline justify-content-end">
             ...
             <li class="list-inline-item dropdown hidden-xs hidden-sm">
                ...
                <span  class="notification-count wave in"></span>                </a>
                <ul class="dropdown-menu shadow-2">
                   ...
                   <li class="notification-box">
                      ...
                      <span id="countdownTimer">Steve rated your photo</span>
             ...
             <li class="list-inline-item dropdown">
                ...
                <ul class="dropdown-menu profile-dropdown shadow-2">
                   <li>
                      ...
                      <a href="{{ route('users.management.my.profile', ['uuid' => auth()->user()->uuid]) }}">
                        <i class="icon-user"></i>
                   ...
                   <li>
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <a style="cursor: pointer"  onclick="event.preventDefault(); this.closest('form').submit();"><i class="icon-logout"></i>Sign Out</a>
                    </form>
                   </li>
