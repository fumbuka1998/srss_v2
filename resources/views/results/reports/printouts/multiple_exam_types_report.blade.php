...
<table>
    <tr>
        <td>NAME:</td>
        <td style="min-width:200px; max-width:250px;"> <strong> <i> {{ strtoupper($rst[$student_id]['results']->full_name)   }} </i> </strong> </td>
        ...
        <td> <strong> <i>  {{ $rst[$student_id]['metadata']->admission_no }}  </i>   </strong> </td>
