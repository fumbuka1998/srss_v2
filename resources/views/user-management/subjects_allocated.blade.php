                ...
                <div class="row mt-4 col-display">
                    ...
                    <div class="col-md-12">
                        <table class="table responsive compact" style="width:100%">
                            <tbody>
                                <tr>
                                    <th class="th-color th-hover">Subject Name</th> <th class="th-center th-hover">  {{ strtoupper($user->firstname.' '.$user->middlename.' '.$user->lastname )   }}</th> <th class="th-center ripple th-hover"><i class="fa-solid fa-angle-right" style="color:#8094ae"></i></th>
                                </tr>
                                <tr>
