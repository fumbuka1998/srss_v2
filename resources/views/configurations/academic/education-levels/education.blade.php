...
<div class="pageheader pd-y-25 mb-3 mt-3" style="background-color: white">
    <div class="row">
        <div class="ml-3 pd-t-5 pd-b-5">
            <h1 class="pd-0 mg-0 tx-20 text-overflow ml-3 new-header">EDUCATION LEVELS</h1>
        </div>
        <div class=" mr-3 breadcrumb pd-0 mg-0 text-right ml-auto">
            ...
            <span class="breadcrumb-item active mr-3">Education Levels</span>
        </div>
    </div>
</div>
@endsection
...
<div class="card">
        ...
        <div class="row">
            <div class="col-md-12 mt-3 mb-2">
                <div class="float-right">
                    ...
                    <a href="javascript:void(0)" title="new Education Level" id="add" type="button" class=" btn btn-info btn-sm" style="border-radius: 2px !important; margin-right: 3px !important"><i class="fa fa-plus-circle"></i>&nbsp;New Education Level</a>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" id="name"  class="form-control" placeholder="eg Advanced Level">
  ...
  let datatable =  $('#table').DataTable({
        processing: true,
        serverSide: true,
        ajax:'{{ route('academic.education.levels.datatable') }}',
        columns:[
        {data: 'name', name:'name'},
        {data: 'code', name:'code'},
...
$('.delete').click(function(){
    ...
    let url = "{{ route("academic.education.levels.destroy") }}"
    let method = "DELETE"
...
$('.edit').click(function(){
    ...
    let uuid = $(this).data('uuid');
    let url = '{{ route('academic.education.levels.edit') }}'
    $.ajax({
...
let url = '{{ route("academic.education.levels.store") }}'
let method = "POST"
