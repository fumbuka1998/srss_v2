...
<div class="pageheader pd-y-25 mb-3 mt-3" style="background-color: white">
    <div class="row">
        <div class="ml-3 pd-t-5 pd-b-5">
            <h1 class="pd-0 mg-0 tx-20 text-overflow ml-3 new-header">CHARACTER ASSESSMENTS</h1>
        </div>
...
<div class="card">
        ...
        <div class="row">
            <div class="col-md-12 mt-3 mb-2">
                <div class="float-right">
                    ...
                    <a href="javascript:void(0)" title="new class" id="add" type="button" class=" btn btn-info btn-sm" style="border-radius: 2px !important; margin-right: 3px !important"><i class="fa fa-plus-circle"></i>&nbsp;New Character</a>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Code</label>
                                <input type="text" id="code" name="code"  class="form-control" placeholder="eg  901..">
   ...
   let datatable = $('#table').DataTable({
        processing: true,
        serverSide: true,
        ajax:'{{ route('character.assessment.datatable') }}',
        columns:[
        {data: 'code', name:'code'},
...
$('.delete').click(function(){
    ...
    let url = "{{ route("character.assessment.destroy") }}"
    let method = "DELETE"
...
$('.edit').click(function(){
    ...
    let uuid = $(this).data('uuid');
    let url = '{{ route('character.assessment.edit') }}'
    $.ajax(
    ...
    $('#uuid').val(res.uuid);
    $('#code').val(res.code);
    $('#description').val(res.assessment);
...
let url = '{{ route("character.assessment.store") }}'
let method = "POST"
