...
<div class="pageheader pd-y-25 mb-3 mt-3" style="background-color:white">
    <div class="row">
        <div class="ml-3 pd-t-5 pd-b-5">
            <h1 class="pd-0 mg-0 tx-20 text-overflow ml-3 new-header">GRADES</h1>
        </div>
        <div class=" mr-3 breadcrumb pd-0 mg-0 text-right ml-auto">
            ...
            <a class="breadcrumb-item" href="{{ route('academic.grades.groups')}}">Grade Groups</a>
            <span class="breadcrumb-item active mr-3">Grades</span>
        </div>
    </div>
...
<div class="card">
        ...
        <div class="row">
            <div class="col-md-12 mt-3 mb-2">
                <div class="float-right">
                    ...
                    <a href="javascript:void(0)" title="new grade" id="add" type="button" class=" btn btn-info btn-sm" style="border-radius: 2px !important; margin-right: 3px !important"><i class="fa fa-plus-circle"></i>&nbsp;New Grade Group</a>
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="group_uuid" value="{{$group_uuid}}" id="group_uuid">
    ...
    let datatable = $('#table').DataTable({
        ...
        ajax: {
        url: '{{ route('academic.grades.datatable') }}',
        beforeSend: function(xhr) {
                    xhr.setRequestHeader('X-CSRF-TOKEN', $('meta[name="csrf-token"]').attr('content'));
                    },
        type: 'POST',
        data: function (d) {
            d.group_uuid = $('#group_uuid').val();
        }
    },
